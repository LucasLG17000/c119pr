quickDrawDataset=["aircraft carrier","airplane","alarm clock","ambulance","angel","animal migration","ant","anvil","apple","arm","asparagus",
                      ...
                      var randomNumber = Math.floor((Math.random()*quickDrawDataset.length)+1);
                        ...
                        document.getElementById("Tipo_de_Esboço").innerHTML = "Esboço a ser Desenhado:"+sketch;
                        var timerCounter = 0;
                        var timerCheck = " ";
                        var drawSketch = " ";
                        var answerHolder = " ";
                      ...
                      function gotResult(error, results){
                        ...
                        console.log(results);
                        var drawSketch = results[0].label;
                        document.getElementById('Esboço').innerHTML = drawSketch;
